...
const AddNewForm = React.createClass({
  ...
  handleAdd: function(e) {
    var callbackAfterSubmit = function(success) {
      ...
      this.setState({category: "", type: "", color: ""})
    }.bind(this);
    ...
    // }
    ajaxHelpers.addNew(this.state.image, this.state.type, this.state.color, this.state.category, callbackAfterSubmit)
  },
  ...
  displayTypeDropdown: function() {
    ...
    if (this.state.category == "top") {
      return (
        <select className="dropdown" title="Item Type" onChange={this.handleType} value={this.state.type}>
      ...
      return (
        <select className="dropdown" title="Item Type" onChange={this.handleType} value={this.state.type}>
          ...
          <option eventKey={"sneakers"}>sneakers</option>
        </select>
      )
    }
  },
  ...
  displayImage: function() {
    if (this.state.image) {
      return (<img className="previewImage" src={this.state.image}/>)
    }
  },
  render: function() {
    return (
      <div>
        <div className="appbody">
          ...
          <input placeholder='Image link' name='image' onChange={e => this.setState({image: e.target.value})}/> {this.displayImage()}
          <select className="dropdown" onChange={this.handleCategory} value={this.state.category}>Category
          ...
          <select className="dropdown" onChange={this.handleColor} value={this.state.color}>Color
